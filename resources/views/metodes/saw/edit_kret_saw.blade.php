...
<div class="container">
  <div class="row justify-content-center">
      ...
      <div class="col-md-6">
        <br>
        <form action="/saw/{{$saw->id}}" method="post">
          {{ csrf_field() }}
          <div class="form-group">
            <div class="input-group mb-3">
              ...
              <input readonly name="kode" type="text" class="form-control" style="text-transform:uppercase" value="{{(old('kode')) ? old('kode') : $saw->kode}}">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="input-group mb-3">
              ...
              <input name="nama_kreteria" type="text" class="form-control" placeholder="Masukkan Nama Kreteria..." value="{{(old('nama_kreteria')) ? old('nama_kreteria') : $saw->nama}}">
            </div>
          </div>
          <div class="form-group">
            @if(session('tipe'))
          ...
          <div class="form-group">
            ...
            <div class="input-group mb-3">
              ...
              <input name="bobot" type="text" class="form-control" placeholder="Masukkan Bobot..." value="{{(old('bobot')) ? old('bobot') : $saw->bobot*100}}">
              <div class="input-group-prepend">
                <span class="input-group-text span-persen">% (Persen)</span>
              </div>
            </div>
          </div>
          <div class="form-group">
